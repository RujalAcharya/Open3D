...
TriangleMesh::QuadricDecimationMappedReturnValue TriangleMesh::SimplifyQuadricDecimationMapping(
        int target_number_of_triangles,
        double maximum_error = std::numeric_limits<double>::infinity(),
        double boundary_weight = 1.0) const {
    if (HasTriangleUvs()) {
    ...
    TriangleMesh::QuadricDecimationMappedReturnValue returnValue;
    ...
    end_flip_loop:
        ...
        // Create Mapping and Append
        TriangleMesh::DecimationMapElement mapElement{
            vbar,
            mesh->vertices_[vidx0],
            mesh->vertices_[vidx1]
        };
        returnValue.DecimationMap.push_back(mapElement);
    ...
    // return mesh;
    returnValue.SimplifiedMesh = mesh;
